...
- [Google Drive 연동](./google-drive.md)
  - 공유 링크, Google Picker, Drive 저장 scope, Cloud 설정과 환경 변수를 정의한다.
...
- [Milestone 5: Part와 Part Mark 편집](./milestones/milestone-5-part-mark-editor.md)
  - Part 설정, audio variant 연결, Main/Sub segment role 편집, Part Mark 추가/삭제 구현 결과를 정의한다.
- [Milestone 6: Viewer Mode](./milestones/milestone-6-viewer-mode.md)
  - 줄글 가사 표시, 현재 cue 강조, auto-scroll, 반복 재생, Viewer Mixer/Parts 패널 구현 결과를 정의한다.
- [Milestone 7: 배포와 문서](./milestones/milestone-7-deployment-docs.md)
  - GitHub Pages 배포, 사용법 문서, 샘플 프로젝트 제공 구현 결과를 정의한다.
